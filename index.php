    ...
    <div id="heroCarousel" data-bs-interval="5000" class="carousel slide carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
          <div class="container">
            <h2>Welcome to <span>Peduli Diri</span></h2>
            <p>"Selamat datang di program Peduli Diri! Kami sangat senang Anda memilih untuk peduli pada diri sendiri. Ini adalah langkah pertama menuju kesejahteraan dan kebahagiaan pribadi Anda. Kami siap mendukung perjalanan Anda menuju perubahan positif dan perbaikan diri. Selamat menjalani setiap langkah perjalanan ini!".</p>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-2.jpg)">
          <div class="container">
            <h2>Siap Hidup Sehat</h2>
            <p>Dengan langkah langkah ini kita akan membawa kita untuk hidup sehat</p>
            <a href="#about" class="btn-get-started scrollto">Read More</a>
          </div>
        </div>
        ...
        <div class="carousel-item" style="background-image: url(assets/img/slide/slide-3.jpg)">
          <div class="container">
            <h2>Ikuti Progam Ini</h2>
            <p>Kami akan membimbing anda dan membawa anda agar hidup sehat.</p>
            <a href="#about" class="btn-get-started scrollto">Read More</a>
          </div>
        </div>
  ...
  <main id="main">
    ...
    <section id="featured-services" class="featured-services">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-i
          
          tems-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="fas fa-heartbeat"></i></div>
              <h4 class="title"><a href="">Denyut Nadi</a></h4>
              <p class="description">Denyut nadi adalah detak jantung yang terasa di arteri, mengukur sirkulasi darah dalam bpm, kunci bagi kesehatan kardiovaskular dan kesejahteraan.</p>
            </div>
          </div>
